...
```{ojs}
[
  {col: ["prenom_query", "nom_query", "date_naissance_query", "lieu_naissance_query"]},
  {val: ["François", "Pignon", 1975, 75014]}
]
```
...
bgcol = value => htl.html`<div style="background: ${
 value === "Pignon" ?  "#a9e4f3" : "#fde9d2"
}">${value}`
